...
Artifacts: 485
Automatic candidates — primary: 207; supporting: 222; pilot: 34; excluded: 22
Manual artifact status: UNREVIEWED for every row; automatic candidate labels are not manuscript adjudications.
Paired metric effects: 441 rows across 147 summaries
Structurally invalid paired-effect rows: 114; these are excluded from provisional RQ2 eligibility.
...
| CBraMod | faced | channel | primary_pair_structurally_invalid | 3 |
...
| CBraMod | faced | patch | primary_pair_structurally_invalid | 3 |
| CBraMod | isruc | channel | control_only | 4 |
| CBraMod | isruc | channel_patch | control_only | 5 |
| CBraMod | isruc | channel_patch | primary_pair_unverified | 3 |
| CBraMod | isruc | patch | control_only | 4 |
| CBraMod | physionet_mi | channel | control_only | 1 |
| CBraMod | physionet_mi | channel | primary_pair_structurally_invalid | 3 |
| CBraMod | physionet_mi | channel_patch | control_only | 5 |
| CBraMod | physionet_mi | patch | control_only | 1 |
| CBraMod | physionet_mi | patch | primary_pair_structurally_invalid | 3 |
| CBraMod | seedv | channel | control_only | 4 |
| CBraMod | seedv | channel | primary_pair_structurally_invalid | 3 |
| CBraMod | seedv | patch | control_only | 3 |
| CBraMod | seedv | patch | primary_pair_structurally_invalid | 3 |
| CBraMod | tuev | channel | control_only | 2 |
| CBraMod | tuev | channel | primary_pair_structurally_invalid | 3 |
...
| CBraMod | tuev | patch | primary_pair_structurally_invalid | 3 |
