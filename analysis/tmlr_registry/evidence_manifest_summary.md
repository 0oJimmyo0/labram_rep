...
Invalid paired-effect rows: 18; these are excluded from provisional RQ2 eligibility.
...
| CBraMod | faced | channel | primary_pair_provisional | 3 |
| CBraMod | faced | channel_patch | control_only | 5 |
| CBraMod | faced | channel_patch | primary_pair_provisional | 3 |
| CBraMod | faced | patch | control_only | 4 |
| CBraMod | faced | patch | primary_pair_provisional | 3 |
| CBraMod | isruc | channel | control_only | 1 |
| CBraMod | isruc | channel | primary_pair_provisional | 3 |
| CBraMod | isruc | channel_patch | control_only | 3 |
| CBraMod | isruc | channel_patch | primary_pair_provisional | 3 |
| CBraMod | isruc | patch | control_only | 1 |
| CBraMod | isruc | patch | primary_pair_provisional | 3 |
| CBraMod | physionet_mi | channel | control_only | 1 |
| CBraMod | physionet_mi | channel | primary_pair_provisional | 3 |
| CBraMod | physionet_mi | channel_patch | control_only | 2 |
| CBraMod | physionet_mi | channel_patch | primary_pair_provisional | 3 |
| CBraMod | physionet_mi | patch | control_only | 1 |
| CBraMod | physionet_mi | patch | primary_pair_provisional | 3 |
| CBraMod | seedv | channel | control_only | 4 |
| CBraMod | seedv | channel | primary_pair_provisional | 3 |
| CBraMod | seedv | patch | control_only | 3 |
| CBraMod | seedv | patch | primary_pair_provisional | 3 |
| CBraMod | tuev | channel | control_only | 2 |
| CBraMod | tuev | channel | primary_pair_provisional | 3 |
| CBraMod | tuev | channel_patch | control_only | 6 |
| CBraMod | tuev | channel_patch | primary_pair_provisional | 3 |
| CBraMod | tuev | patch | control_only | 1 |
| CBraMod | tuev | patch | primary_pair_provisional | 3 |
...
| LaBraM | TUEV | channel | primary_pair_invalid | 3 |
| LaBraM | TUEV | channel_patch | primary_pair_provisional | 3 |
| LaBraM | TUEV | patch | primary_pair_invalid | 3 |
